...
@section('konten')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        @if (auth()->user()->id_eskul)
            <h1 class="h2">Tambah Data Prestasi Ekstrakulikuler {{ $tb_eskul->find(auth()->user()->id_eskul)->nama_prestasi }}</h1>
        @else
            <h1 class="h2">Tambah Data Prestasi</h1>
        @endif
    </div>
